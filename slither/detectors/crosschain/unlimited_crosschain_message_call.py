...
class CrosschainMessageInjection(AbstractDetector):
    ...
    ARGUMENT = "unlimited-crosschain-message-call"
    ...
    WIKI = ""
    WIKI_TITLE = "Unlimited Crosschain Message Call"
    WIKI_DESCRIPTION = "Unlimited Crosschain Message Call"
...
"""
    ...
    WIKI_RECOMMENDATION = "unlimited-crosschain-message-call."
            ...
            for node in function.nodes:
                ...
                for ir in node.irs + slithir_operation:
                    if isinstance(ir, HighLevelCall) or isinstance(ir, LowLevelCall):
                        if ir.destination.is_reentrant:
    ...
    def _detect(self) -> List[Output]:
        ...
        for contract in self.compilation_unit.contracts_derived:
            ...
            for (function, node) in crosschain_message_injections:
                info: DETECTOR_INFO = ["Found Unlimited Cross-Chain Message Call in ", function, "\n"]
                info += ["\t- ", node, " \n"]
