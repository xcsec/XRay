...
class BypassingCrosschainMessageCheckOPORRelayer(AbstractDetector):
    """
    Missing events for critical contract parameters set by owners and used in access control
    """

    ARGUMENT = "invalid-merkle-proof-verification"
    ...
    WIKI = "invalid-merkle-proof-verification"
    WIKI_TITLE = "invalid-merkle-proof-verification"
    WIKI_DESCRIPTION = "bypassing-bridged-message-check-op/relayer"
    dependency_relation = {}
...
"""
    ...
    WIKI_RECOMMENDATION = "bypassing-crosschain-message-check-op"
    ...
    def _detect(self) -> List[Output]:
        ...
        for contract in self.compilation_unit.contracts_derived:
            ...
            for function in missing_crosschain_data_checks:
                info: DETECTOR_INFO = ["Missing Crosschain Data Check was found in a op bridge", function, "\n"]
